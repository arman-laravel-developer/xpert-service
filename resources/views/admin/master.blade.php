...
<div class="wrapper">
        ...
        <div class="container-fluid detached-nav">
            ...
            <div class="logo-topbar">
                ...
                <a href="{{route('dashboard')}}" class="logo-light">
                            <span class="logo-lg">
                                <img src="{{asset($generalSettingView->footer_logo)}}" alt="logo" >
                            </span>
                    <span class="logo-sm">
                                <img src="{{asset($generalSettingView->footer_logo)}}" alt="small logo">
                            </span>
                </a>
                ...
                <a href="{{route('dashboard')}}" class="logo-dark">
                            <span class="logo-lg">
                                <img src="{{asset($generalSettingView->footer_logo)}}" alt="dark logo" >
                            </span>
                    <span class="logo-sm">
                                <img src="{{asset($generalSettingView->footer_logo)}}" alt="small logo">
                            </span>
            ...
            <ul class="list-unstyled topbar-menu float-end mb-0">
                ...
                <li class="dropdown notification-list">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                        ...
                        <!-- item-->
                        <a href="{{ route('setting.add') }}" class="dropdown-item notify-item">
            ...
            <div class="app-search dropdown">
                <form>
                    <div class="input-group">
                        ...
                        <a href="{{route('clear-cache')}}"  class="input-group-text btn btn-outline-danger text-center" style="margin-left: 5%" >Cache Clear</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="leftside-menu">
        ...
        <a href="{{route('dashboard')}}" class="logo logo-light">
                    <span class="logo-lg">
                        <img src="{{asset($generalSettingView->footer_logo)}}" alt="logo" style="width: 80%;height: 100%;">
                    </span>
            <span class="logo-sm">
                        <img src="{{asset($generalSettingView->footer_logo)}}" alt="small logo" style="width: 80%;height: 100%;">
                    </span>
        </a>
        ...
        <a href="{{route('dashboard')}}" class="logo logo-dark">
                    <span class="logo-lg">
                        <img src="{{asset($generalSettingView->footer_logo)}}" alt="dark logo"  style="width: 80%;height: 100%;">
                    </span>
            <span class="logo-sm">
                        <img src="{{asset($generalSettingView->footer_logo)}}" alt="small logo" style="width: 80%;height: 100%;">
                    </span>
    ...
    <div class="content-page">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <script>document.write(new Date().getFullYear())</script> © {{$generalSettingView->site_name}}
                    </div>
                </div>
            </div>
        </footer>
